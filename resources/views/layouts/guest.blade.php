...
<head>
    ...
    <title>Login — SIPEGAN Disdukcapil Kab. Tegal</title>
    <meta name="description" content="Sistem Pelayanan Magang dan Penelitian Dinas Kependudukan dan Pencatatan Sipil Kabupaten Tegal">
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* Hilangkan icon mata (reveal password) bawaan browser Edge/IE */
...
<body>
    ...
    <div class="brand-panel">
        ...
        <div class="brand-content">
            ...
            <div class="logos-row">
                <div class="logo-wrap">
                    <img src="{{ asset('images/tegal-logo.png') }}" alt="Logo Kabupaten Tegal" class="logo-img">
            ...
            <p class="brand-subtitle">
                Sistem Pelayanan Magang dan Penelitian Dinas Dukcapil Kabupaten Tegal.
            </p>
